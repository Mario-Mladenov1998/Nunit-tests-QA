    ...
    public class DuplicatesTests
    {
        ...
        private static IEnumerable<TestCaseData> GetDuplicatesTestCases()
        {
            yield return new TestCaseData(
                new int[] { 1, 2, 2, 3, 3, 3 },
                new int[] { 2, 3 })
                .SetName("MixedInput_ReturnsUniqueDuplicates");

            yield return new TestCaseData(
                new int[] { 1, 1, 1, 1 },
                new int[] { 1 })
                .SetName("SingleNumberRepeats_ReturnsSingleDuplicate");

            yield return new TestCaseData(
                new int[] { 1, 2, 3, 4 },
                Array.Empty<int>())
                .SetName("NoDuplicates_ReturnsEmpty");

            yield return new TestCaseData(
                Array.Empty<int>(),
                Array.Empty<int>())
                .SetName("EmptyInput_ReturnsEmpty");

            yield return new TestCaseData(
                new int[] { -1, -1, 0, 1, 1 },
                new int[] { -1, 1 })
                .SetName("NegativeNumbers_WorkCorrectly");
        }
